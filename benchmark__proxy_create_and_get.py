...
def create_patient(patient_data):
    return proxy_api.create_patient(patient_data)

@timed.measure("get_patient")
def get_patient(patient_id):
    return proxy_api.get_patient(patient_id)

def main():
    timed.clear_all()
    proxy_api.clear_statistics()
    ...
    api_statistics = proxy_api.get_statistics()
    ...
    dir_name = benchmark_utils.time_formatted() + "--PROXY--CREATE_AND_GET"
    os.mkdir(dir_name)
